...
| 14 ก.ย. `On floor 1-2` | norawit.kij |
...
- เวรที่แลกได้: `8.00 - 16.00`, `On floor 1-2`, `16.00 - 24.00`, `0.00 - 8.00` (block ละ 8 ชม. แลกข้ามช่วงได้) — ไม่รวม conference
...
| # | ขั้นตอน | ผลที่คาด |
|---|---|---|
| 1 | **Happy path หลายเวร**: login `norawit29@gmail.com` ส่ง Form: ชื่อคุณ=norawit29, เวร #1 = 10 ก.ย. `8.00 - 16.00`, #2 = 11 ก.ย. `16.00 - 24.00`; อีกฝ่าย=norawit.kij, เวร #1 = 12 ก.ย. `0.00 - 8.00`, #2 = 14 ก.ย. `On floor 1-2` | `Swap log` มีแถว `pending_b`; norawit.kij29 ได้อีเมลมีปุ่ม 2 ปุ่ม + รายการ 4 เวร; norawit29 ได้อีเมล "ส่งคำขอแล้ว" |
